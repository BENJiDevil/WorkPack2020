...
global.settings = {
    ...
    magnificpopup           : false,                                                                                        // magnific popup
    wow                     : false,                                                                                        // WOW
    maskedinput             : false,                                                                                        // maskedinput
    formstyler              : false,                                                                                        // formstyler
    owlcarousel             : false,                                                                                        // owl carousel
    jparallax               : false,                                                                                        // parallax
    rangeslider             : false,                                                                                        // range slider
    slickcarousel           : false,                                                                                        // slick carousel
    ...
    site_lang               : 'ru',
    site_name               : 'newscript',
    db_name                 : 'newscript',                                                                                  // db name
    user_name               : 'newscript',                                                                                  // user name
